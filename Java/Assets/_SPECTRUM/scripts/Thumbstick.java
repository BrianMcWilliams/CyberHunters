...
public class Thumbstick extends MonoBehaviour implements IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	private boolean thumbImageMoving;
	...
	public final void OnDrag(PointerEventData data)
	{
