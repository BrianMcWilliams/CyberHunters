...
//ORIGINAL LINE: [DefaultExecutionOrder(-100)] public class PlayerInput : MonoBehaviour
public class PlayerInput extends MonoBehaviour
{
	public boolean testTouchControlsInEditor = false; //Should touch controls be tested?
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [HideInInspector] public float horizontal;
	public float horizontal; //Float that stores horizontal input
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [HideInInspector] public bool jumpHeld;
	public boolean jumpHeld; //Bool that stores jump pressed
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [HideInInspector] public bool jumpPressed;
	public boolean jumpPressed; //Bool that stores jump held
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [HideInInspector] public bool crouchHeld;
	public boolean crouchHeld; //Bool that stores crouch pressed
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [HideInInspector] public bool crouchPressed;
	public boolean crouchPressed; //Bool that stores crouch held

	private boolean dPadCrouchPrev; //Previous values of touch Thumbstick
	private boolean readyToClear; //Bool used to keep input in sync
	...
	private void ProcessTouchInputs()
	{
		...
		boolean dPadCrouch = thumbstickInput.y <= -verticalDPadThreshold;
