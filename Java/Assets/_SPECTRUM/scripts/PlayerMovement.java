...
{
	public boolean drawDebugRaycasts = true; //Should the environment checks be visualized

//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [Header("Movement Properties")] public float speed = 8f;
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [Header("Jump Properties")] public float jumpForce = 6.3f;
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [Header("Environment Check Properties")] public float footOffset = 0.2f;
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [Header("Status Flags")] public bool isOnGround;
	public boolean isOnGround; //Is the player on the ground?
	public boolean isJumping; //Is player jumping?
	public boolean isHanging; //Is player hanging?
	public boolean isCrouching; //Is player crouching?
	...
	private static final float smallAmount = .05f; //A small amount used for hanging position
