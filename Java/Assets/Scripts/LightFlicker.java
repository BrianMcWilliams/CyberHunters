...
public class LightFlicker extends MonoBehaviour
{
	public float amount; //The amount of light flicker
	public float speed; //The speed of the flicker

	private Light localLight; //Reference to the light component
	private float intensity; //The collective intensity of the light component
	private float offset; //An offset so all flickers are different
