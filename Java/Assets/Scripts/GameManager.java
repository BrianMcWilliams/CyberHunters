...
public class GameManager extends MonoBehaviour
{
	...
	private ArrayList<Orb> orbs; //The collection of scene orbs
	private Door lockedDoor; //The scene door
	private SceneFader sceneFader; //The scene fader

	private int numberOfDeaths; //Number of times player has died
	private float totalGameTime; //Length of the total game time
	private boolean isGameOver; //Is the game currently over?
	...
	public static void RegisterOrb(Orb orb)
	{
		...
		UIManager.UpdateOrbUI(current.orbs.size());
	}
